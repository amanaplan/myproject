(function ($) {
    ...
    Plugin.prototype._init = function() {
        ...
        $parent.append('<div class="ups-table-comparison_sm"></div>');
        var $sm = $parent.find('.ups-table-comparison_sm');

        plugin.$mainHeader = plugin.$T.find('thead th');
        plugin.$secondaryHeaders = plugin.$T.find('tbody th');
