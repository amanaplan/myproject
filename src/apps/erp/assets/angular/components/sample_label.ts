//EXPERIMENTING: DO NOT ADD TO PRODUCTION
...
@Component({
    ...
    templateUrl: 'assets/resources/angular/erp/assets/angular/templates/sample_label.tpl.html',
    host: {
        '(window:resize)' : 'resize($event)'
    },
    providers : [ BrowserWindow, ViewPorts]
})
export class SampleLabelComponent implements AfterViewInit {
