...
@Component({
    templateUrl: 'assets/resources/angular/nbs/assets/angular/templates/nonFormModals/modalInvAdd.tpl.html',
})

export class ModalInvAddComponent implements AfterViewInit {
